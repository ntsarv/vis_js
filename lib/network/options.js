...
let allOptions = {
  ...
  nodes: {
    ...
    shape: { string: ['ellipse', 'circle', 'database', 'box', 'text', 'image', 'circularImage', 'diamond', 'dot', 'star', 'triangle', 'triangleDown', 'square', 'mydesign','icon'] },
    shapeProperties: {
...
let configureOptions = {
  nodes: {
    ...
    shape: ['ellipse', 'box', 'circle', 'database', 'diamond', 'dot', 'square', 'mydesign','star', 'text', 'triangle', 'triangleDown'],
    shapeProperties: {
      borderDashes: false,
